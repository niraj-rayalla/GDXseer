...
### Core:
`api("io.github.niraj_rayalla:GDXseer:1.0.0")`
### Desktop:
`api("io.github.niraj_rayalla:GDXseer-desktop:1.0.0")`
### Android:
```
...
android {
   dependencies {
      api("io.github.niraj_rayalla:GDXseer-android:1.0.0")
      native("io.github.niraj_rayalla:GDXseer-android:$gdxseerVersion")
   }
}
...
`api("io.github.niraj_rayalla:GDXseer-ios-GL:1.0.0")`

OR

If you're using RoboVM-Metal backend:

`api("io.github.niraj_rayalla:GDXseer-ios-Metal:1.0.0-WIP")`
...
4. Load particle effects by doing the following:
    ...
    particleEffect.syncLoad(assetManager, "data/tu.efk", false)
    // For asynchronous loading
    particleEffect.asyncLoad(assetManager, "data/tu.efk", false, object: GDXseerParticleEffect.Companion.LoadedListener {
